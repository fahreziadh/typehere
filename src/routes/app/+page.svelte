...
<div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
	{#each data.listForm as dataForm}
		<a
		...
		>
			<div class="flex justify-center items-center h-20 text-foreground font-medium md:text-base text-sm">
				{dataForm.title ? dataForm.title : 'Untitled'}
			</div>
			<div class="border-t group-hover:border-foreground/30 transition-all p-2 grid grid-cols-5 text-xs px-4">
				<div class="col-span-4 place-self-start inline-flex gap-4 opacity-70 group-hover:opacity-100">

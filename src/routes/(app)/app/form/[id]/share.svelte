...
<div class="min-h-[80vh]" in:fade={{easing: circOut}}>
	<div
		class="p-6 flex flex-col items-center justify-center text-center rounded-md w-full border min-h-[30vh]"
	>
		<h1 class="text-2xl font-semibold pb-4 pt-3">Bagikan form</h1>
